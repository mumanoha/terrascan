...
| **STEP 5: Rover Hardware** | [**docs/figures/02a_robot_cad_concept.md**](docs/figures/02a_robot_cad_concept.md)<br>[**docs/figures/02b_robot_wiring.md**](docs/figures/02b_robot_wiring.md)<br>[**hardware/bom.md**](hardware/bom.md)<br>[**hardware/sensor_calibration.md**](hardware/sensor_calibration.md) | 25 mins | See the 3-view CAD layout, complete electronics wiring diagram, $1,482 BOM, and battery runtime math. |
| **STEP 6: System & Cloud Architecture, Papers & Deliverables** | [**docs/figures/01_system_overview.md**](docs/figures/01_system_overview.md)<br>[**docs/figures/03_gcp_technical_architecture.md**](docs/figures/03_gcp_technical_architecture.md)<br>[**docs/isef_abstract.md**](docs/isef_abstract.md)<br>[**docs/paper_draft.md**](docs/paper_draft.md)<br>[**research/06_competing_solutions_landscape.md**](research/06_competing_solutions_landscape.md) | 30 mins | Trace the executive overview, GCP cloud data pipeline, read your official 247-word ISEF abstract, and view the full research manuscript. |

...
| **STEP 5: Rover Hardware** | [**docs/figures/02a_robot_cad_concept.md**](docs/figures/02a_robot_cad_concept.md)<br>[**hardware/bom.md**](hardware/bom.md)<br>[**hardware/sensor_calibration.md**](hardware/sensor_calibration.md) | 20 mins | See the 3-view CAD layout, $1,482 robot parts list, battery runtime math, and active calibration contact probe. |

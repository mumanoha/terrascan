...
- **Decision**:
  ...
  5. *Power Derivation*: Calculated theoretical power budget of $8.21\text{ hours}$ continuous field runtime on 256 Wh LiFePO4 battery ($25.96\text{ W}$ average draw at 85% DoD and 90% converter efficiency) and $+50.7\text{ Wh/day}$ net-positive solar equilibrium under PA insolation ($154.5\text{ Wh/day}$ generation vs. $103.8\text{ Wh/day}$ 4-hour operational survey load).
